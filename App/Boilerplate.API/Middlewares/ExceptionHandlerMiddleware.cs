    ...
    public class ExceptionHandlerMiddleware
    {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            catch (Exception exception)
            {
                ...
                var logMessage = JsonConvert.SerializeObject(problemDetailsContext.ProblemDetails, Formatting.Indented, new JsonSerializerSettings
                {
                ...
                {
                    Elastic.Apm.Agent.Tracer.CurrentTransaction.CaptureException(exception, isHandled: true);
                }
